...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "primary", size = "md", isLoading, asChild = false, children, ...props }, ref) => {
    ...
    const sizes = {
      ...
      lg: "px-4 py-1.5 sm:px-6 sm:py-2 text-sm sm:text-base md:text-lg min-h-[44px] sm:min-h-[48px] md:min-h-[52px]",
      xl: "px-6 py-3 sm:px-8 sm:py-4 md:px-10 md:py-5 text-base sm:text-lg md:text-xl min-h-[48px] sm:min-h-[56px] md:min-h-[64px]",
    }
