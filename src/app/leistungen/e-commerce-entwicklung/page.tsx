          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            {platforms.map((platform, index) => (
              <motion.div
                ...
                whileHover={{ scale: 1.02 }}
              >
                <PriceLabel price={platform.price} className="text-orange-400 font-bold text-xs xs:text-sm sm:text-base md:text-lg mb-4" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            {ecommerceServices.map((service, index) => (
              <motion.div
                ...
                whileHover={{ scale: 1.02 }}
              >
                <PriceLabel price={service.price} className="text-blue-400 font-bold text-xs xs:text-sm sm:text-base md:text-lg mb-4" />
