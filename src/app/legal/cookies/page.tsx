...
export default function CookiePolicyPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-800 py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        <div className="bg-zinc-900/50 backdrop-blur-sm border border-zinc-800 rounded-2xl shadow-xl p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-300 space-y-8">
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">Was sind Cookies?</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">Wie verwenden wir Cookies?</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">Arten von Cookies</h2>
              
              <div className="space-y-6">
                  <div className="bg-zinc-800/50 border border-zinc-700 p-6 rounded-lg">
                   <h3 className="text-xl font-medium text-gray-200 mb-3">Notwendige Cookies</h3>
                  ...
                  <p className="text-sm text-blue-700 mt-2"><strong>Speicherdauer:</strong> Session</p>
                </div>

                <div className="bg-zinc-800/50 border border-zinc-700 p-6 rounded-lg">
                   <h3 className="text-xl font-medium text-gray-200 mb-3">Funktionale Cookies</h3>
                    <p className="text-gray-300">
                  ...
                  <p className="text-sm text-green-700 mt-2"><strong>Speicherdauer:</strong> 30 Tage</p>
                </div>

                <div className="bg-zinc-800/50 border border-zinc-700 p-6 rounded-lg">
                   <h3 className="text-xl font-medium text-gray-200 mb-3">Analytische Cookies</h3>
                    <p className="text-gray-300">
                    Diese Cookies helfen uns zu verstehen, wie Besucher mit unserer Website interagieren, 
                    indem sie Informationen anonym sammeln und melden. Dies hilft uns, die Leistung unserer 
                    Website zu verbessern.
                  </p>
                  <p className="text-sm text-yellow-700 mt-2"><strong>Speicherdauer:</strong> 2 Jahre</p>
                </div>

                <div className="bg-zinc-800/50 border border-zinc-700 p-6 rounded-lg">
                   <h3 className="text-xl font-medium text-gray-200 mb-3">Marketing Cookies</h3>
                    <p className="text-gray-300">
                  ...
                  <p className="text-sm text-purple-700 mt-2"><strong>Speicherdauer:</strong> 1 Jahr</p>
                </div>
              </div>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">Drittanbieter-Cookies</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">Cookie-Einstellungen verwalten</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">Browser-spezifische Anleitungen</h2>
...
<p><strong>Adresse:</strong> Vera IT Marketing-Agentur, Rehrstieg 16d, 21147, 20095 Hamburg, Deutschland</p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">Änderungen an dieser Richtlinie</h2>
              <p>
