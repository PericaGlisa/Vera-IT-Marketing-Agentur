        ...
        <div className="bg-zinc-900/50 backdrop-blur-sm border border-zinc-800 rounded-2xl shadow-xl p-8 md:p-12">
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <div className="bg-zinc-800/50 border border-zinc-700 p-6 rounded-lg">
                <p className="text-gray-300"><strong className="text-white">Telefon:</strong> +49 15563 740470</p>
        <p className="text-gray-300"><strong className="text-white">E-Mail:</strong> info@verait.de</p>
                <p className="text-gray-300"><strong className="text-white">Website:</strong> verait.de</p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="bg-zinc-800/50 border border-zinc-700 p-6 rounded-lg">
                <p className="text-gray-300"><strong className="text-white">Geschäftsführer:</strong> Max Mustermann</p>
                <p className="text-gray-300"><strong className="text-white">Handelsregister:</strong> HRB 123456</p>
                <p className="text-gray-300"><strong className="text-white">Registergericht:</strong> Amtsgericht Hamburg</p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="bg-zinc-800/50 border border-zinc-700 p-4 rounded-lg">
                <p className="font-mono text-white">DE123456789</p>
              </div>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">Berufsbezeichnung und berufsrechtliche Regelungen</h2>
              <p className="text-gray-300 mb-3">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">Redaktionell verantwortlich</h2>
              <div className="bg-zinc-800/50 border border-zinc-700 p-6 rounded-lg">
